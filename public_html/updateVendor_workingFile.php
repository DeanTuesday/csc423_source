	...
	<form id='updateForm' name='updateForm' method='POST' action='updateVendor.php' onsubmit='validateTheDatas();'>
		<table align='center'>
			...
			<tr>
				...
				<td><input type='text' id='vendorCode' name='vendorCode' value="$vendorCode"></td>
			</tr>
			<tr>
				<td><label>Vendor Name:</label></td>
				<td><input type='text' id='vendorName' name='vendorName' value='$vendorName'></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type='text' id='contactPersonName' name='contactPersonName' value='$contactPersonName'></td>
			</tr>
			<tr>
				<td><label>Vendor Status:</label></td>
				<td><?php include('./inc/setVendorStatusOption.php'); ?></td>
			</tr>
